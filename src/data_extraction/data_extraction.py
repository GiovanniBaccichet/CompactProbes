...
def main():
    ...
    with Progress() as progress:
        ...
        dataset_task = progress.add_task("[cyan]Processing datasets...", total=len(config.sections()))
        ...
        for i in config.sections():
            ...
            file_task = progress.add_task(f"[green]Processing files in {i}...", total=len(pcap_files))
